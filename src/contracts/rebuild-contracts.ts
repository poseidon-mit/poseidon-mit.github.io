...
export const ROUTE_META_CONTRACT: Record<string, RouteMetaContract> = {
  '/': routeMeta({
    ...
    first5sMessage: 'This is a banking-grade AI decisioning platform with multi-model deliberation.',
    demoPriority: 'P0',
  ...
  '/protect/threats': routeMeta({
    ...
    governance: { auditId: 'GV-2026-0216-PRT-THR', pageContext: 'threat triage', engine: 'protect' },
    evidence: EVIDENCE_SUMMARY,
  }),
...
export const CROSS_SCREEN_DATA_THREAD: Record<CrossThreadKey, CrossThreadDatum> = {
  ...
  critical_alert_thr001: {
    ...
    displayFormat: 'THR-001 · $2,500,000 · Cayman Reef Holdings · 0.94',
  ...
  monthly_optimization: {
    ...
    value: 24_500,
    displayFormat: '$24,500/month',
    ownerRoutes: ['/', '/dashboard', '/execute', '/execute/history'],
    description: 'Portfolio optimization metric used across recommendation and execution reporting.',
  },
  liquidity_reserve: {
    ...
    displayFormat: '82% · $41M / $50M',
    ownerRoutes: ['/dashboard', '/grow', '/grow/goal', '/grow/scenarios'],
    description: 'Institutional liquidity reserve KPI for portfolio health and scenario routes.',
  },
  cohort_acceptance_rate: {
  ...
  cohort_fraud_trend: {
    ...
    value: { label: 'Counterparty risk incidents up 18% this quarter', changePercent: 18, period: 'Q1 2026' },
    displayFormat: 'Counterparty risk +18% Q1 2026',
    ownerRoutes: ['/', '/protect'],
    description: 'Platform-level counterparty risk trend intelligence shown on landing and protect.',
  },
  projected_3y_advantage: {
    key: 'projected_3y_advantage',
    value: 541800,
    displayFormat: '+$541,800',
    ownerRoutes: ['/', '/grow'],
    description: 'Projected 3-year advantage from B2B grow simulation, shown on landing hero and grow hero.',
  },
  zero_auto_executions: {
