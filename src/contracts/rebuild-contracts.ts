...
export const CROSS_SCREEN_DATA_THREAD: Record<CrossThreadKey, CrossThreadDatum> = {
  ...
  critical_alert_thr001: {
    ...
    value: {
      ...
      merchant: 'AMZN Mktp US*3K7R2F',
      confidence: 0.94,
      cardLast4: '4821',
      signalId: 'PRT-2026-0309-001',
    },
    displayFormat: 'THR-001 · $347.89 · AMZN Mktp US*3K7R2F · 0.94',
  ...
  pending_actions: {
    key: 'pending_actions',
    value: 7,
    displayFormat: '7 pending actions',
  ...
  liquidity_reserve: {
    ...
    displayFormat: '35% · $14,280 / $40,800',
  ...
  cohort_fraud_trend: {
    ...
    value: { label: 'Subscription fraud attempts up 23% this quarter', changePercent: 23, period: 'Q1 2026' },
    displayFormat: 'Subscription fraud +23% Q1 2026',
    ownerRoutes: ['/', '/protect'],
