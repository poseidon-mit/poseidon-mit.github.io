...
export const ROUTE_META_CONTRACT: Record<string, RouteMetaContract> = {
  ...
  '/orchestrator': routeMeta({
    ...
    demoPriority: 'P0',
    governance: { auditId: 'AUD-891', pageContext: 'Orchestrator v4.0 — Context-Aware Intent Workspace', engine: 'govern' },
    evidence: EVIDENCE_SUMMARY,
  }),
...
export const CROSS_SCREEN_DATA_THREAD: Record<CrossThreadKey, CrossThreadDatum> = {
  ...
  critical_alert_thr001: {
    ...
    value: {
      ...
      merchant: 'Apple Store Miami',
      confidence: 0.94,
      cardLast4: '4821',
      signalId: 'PRT-2026-0312-001',
    },
    displayFormat: 'THR-001 · $1,299 · Apple Store Miami · 0.94',
  ...
  pending_actions: {
    key: 'pending_actions',
    value: 20,
    displayFormat: '20 pending actions',
  ...
  liquidity_reserve: {
    ...
    displayFormat: '70% · $42,100 / $60,000',
  ...
  projected_3y_advantage: {
    ...
    value: 3300,
    description: 'Average 3-year projected financial advantage over baseline for the cohort',
    displayFormat: '+$3,300',
    ownerRoutes: ['/', '/grow'],
  },
  zero_auto_executions: {
