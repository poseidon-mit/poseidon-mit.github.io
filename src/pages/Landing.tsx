...
function useSpotlight() {
  ...
  const onPointerMove = (e: RPointerEvent<HTMLDivElement>) => {
    ...
    if (!rect) return
    pt.current = { x: e.clientX - rect.left, y: e.clientY - rect.top }
    if (!frame.current) {
      frame.current = requestAnimationFrame(() => {
        ref.current?.style.setProperty('--spot-x', `${pt.current.x}px`)
        ref.current?.style.setProperty('--spot-y', `${pt.current.y}px`)
        frame.current = null
      })
    }
  }
...
export default function Landing() {
  ...
  const spotProtect = useSpotlight()
      ...
      <div className="relative z-10 w-full">
        ...
        <main id="main-content" role="main">
          ...
          <section ref={heroSectionRef} className="relative w-full min-h-screen flex flex-col items-center justify-center pt-[102px] px-6">
            ...
            >
              {/* Badge */}
              <motion.div variants={fadeUp} className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 md:backdrop-blur-md">
              ...
              <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
                ...
                <Link
                  to="/dashboard"
                  className="w-full sm:w-auto flex items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/5 md:backdrop-blur-xl px-8 py-4 min-h-[44px] text-sm font-medium text-white hover:bg-white/10 transition-colors"
                >
              ...
              <motion.div variants={fadeUp} className="flex items-center justify-center gap-3">
                <Link
                  to="/deck"
                  className="flex items-center gap-2 rounded-full border border-white/15 bg-white/[0.06] md:backdrop-blur-md px-5 py-2.5 text-sm font-medium text-white/80 hover:text-white hover:bg-white/10 hover:border-white/25 transition-all"
                >
              ...
              <motion.div variants={fadeUp} className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-2xl mt-6 md:mt-10">
                ...
                <div className="rounded-2xl border border-violet-500/20 bg-white/[0.03] md:backdrop-blur-sm p-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <span className="text-sm font-mono font-bold bg-gradient-to-r from-violet-400 to-purple-400 bg-clip-text text-transparent">
          ...
          <section className="relative w-full py-28 md:py-36 px-6">
            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                ...
                <motion.div variants={fadeUp} className="relative rounded-2xl border border-blue-500/15 bg-white/[0.03] p-5 text-center overflow-hidden shadow-[0_1px_2px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.03)] transition-all duration-300 md:hover:-translate-y-1 md:hover:shadow-[0_0_24px_rgba(59,130,246,0.1)]">
                  ...
                  <p className="text-[10px] sm:text-xs text-white/40 mt-2">Decisions audited & logged</p>
                </motion.div>
                {/* Grow — Cohort optimization */}
                <motion.div variants={fadeUp} className="relative rounded-2xl border border-violet-500/15 bg-white/[0.03] p-5 text-center overflow-hidden shadow-[0_1px_2px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.03)] transition-all duration-300 md:hover:-translate-y-1 md:hover:shadow-[0_0_24px_rgba(139,92,246,0.1)]">
                  ...
                  <p className="text-[10px] sm:text-xs text-white/40 mt-2">Avg monthly optimization identified</p>
                </motion.div>
                {/* Execute — Zero auto-executions */}
                <motion.div variants={fadeUp} className="relative rounded-2xl border border-amber-500/15 bg-white/[0.03] p-5 text-center overflow-hidden shadow-[0_1px_2px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.03)] transition-all duration-300 md:hover:-translate-y-1 md:hover:shadow-[0_0_24px_rgba(234,179,8,0.1)]">
                  ...
                  <p className="text-[10px] sm:text-xs text-white/40 mt-2">Auto-executions without human consent</p>
                </motion.div>
                ...
                <motion.div variants={fadeUp} className="relative rounded-2xl border border-blue-500/15 bg-white/[0.03] p-5 text-center overflow-hidden shadow-[0_1px_2px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.03)] transition-all duration-300 md:hover:-translate-y-1 md:hover:shadow-[0_0_24px_rgba(59,130,246,0.1)]">
                  ...
                  <p className="text-[10px] sm:text-xs text-white/40 mt-2">AI decisions fully audited</p>
                </motion.div>
              </div>
            </motion.div>
          </section>
          ...
          <section className="relative w-full py-32 md:py-40 px-6">
            <motion.div
              ...
              {...sectionRevealProps}
            >
              <motion.h2 variants={fadeUp} className="text-3xl md:text-5xl font-light tracking-tight text-white text-center mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                ...
                <motion.div ref={spotGrow.ref} onPointerMove={spotGrow.onPointerMove} variants={fadeUp} className="group relative rounded-[32px] border border-violet-500/15 bg-white/[0.02] p-6 md:p-8 flex flex-col gap-5 shadow-[0_1px_2px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.03)] transition-all duration-300 md:hover:-translate-y-1 md:hover:shadow-[0_0_24px_rgba(139,92,246,0.1)] overflow-hidden">
                  ...
                  <div className="flex items-baseline gap-1">
                    ...
                    <span className="text-2xl font-mono font-semibold bg-gradient-to-r from-violet-400 to-purple-400 bg-clip-text text-transparent">
                      ${cohort.projected3yAdvantageUsd.toLocaleString()}
                    </span>
                  </div>
