...
import { DEMO_THREAD } from '@/lib/demo-thread';import { Surface } from "@/design-system";
      ...
      <nav className="glass-header border-b border-white/[0.06]">
        <div className="mx-auto flex h-14 max-w-[1280px] items-center justify-between px-4 md:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/signup" className="rounded-xl bg-[var(--engine-protect)] px-4 py-2 text-xs font-semibold text-slate-950 transition-opacity hover:opacity-90">Get started</Link>
          </div>
        </div>
      </nav>
      ...
      <motion.div id="main-content" role="main" className="mx-auto flex flex-col gap-8 md:gap-12 px-4 py-10 md:px-6 md:py-16 lg:px-8" style={{ maxWidth: '1280px' }} variants={stagger} initial="hidden" animate="visible">
        ...
        <motion.div variants={fadeUp} className="text-center flex flex-col items-center gap-4 py-8">
          <div className="flex gap-3">
            <Link to="/dashboard" className="flex items-center gap-1.5 px-6 py-3 rounded-xl text-sm font-semibold text-slate-950 hover:opacity-90 transition-opacity" style={{ background: 'var(--engine-protect)' }}>
