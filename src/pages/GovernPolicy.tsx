        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 lg:w-2/3 flex flex-col gap-4">
            <motion.div variants={fadeUp} className="flex flex-col gap-3">
              {displayed.map((p) => <Surface
                key={p.name} className="rounded-2xl overflow-hidden" variant="glass" padding="none" data-surface-role="structure">
                  <div className="p-4 md:p-5">
                    ...
                    <Button onClick={() => setExpanded(expanded === p.name ? null : p.name)} variant="ghost" engine="govern" size="sm" className="flex items-center gap-1 mt-2 text-xs font-medium hover:opacity-80 transition-opacity !px-0 !h-auto !min-h-0">
                ...
                <div className="px-4 md:px-5 pb-4 border-t border-white/[0.06]">
                      ...
                      <div className="flex gap-2 mt-3">
                        <Button variant="secondary" engine="govern" size="sm" className="flex items-center gap-1 rounded-lg text-xs font-medium">
              ...
              {!showAll &&
              <Button onClick={() => setShowAll(true)} variant="ghost" engine="govern" size="sm" className="text-sm font-medium hover:opacity-80 transition-opacity text-center py-2 !px-0">
