  ...
  return (
    <motion.div variants={fadeUp}>
      <div
        ...
        style={{ borderColor: goal.status === 'Behind' ? 'var(--state-warning)' : 'rgba(139,92,246,0.3)' }}
      >
        ...
        <div className="relative z-10 flex flex-col gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            {goal.actions.map((action, i) => (
              <button
                key={action}
                className={cn(buttonVariants({ variant: i === 0 ? 'glass' : 'secondary', size: 'sm' }), "rounded-xl text-xs")}
