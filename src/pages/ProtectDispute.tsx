          ...
          <motion.div variants={fadeUpVariant} className="flex-1 min-w-0 lg:w-2/3 flex flex-col gap-4">
            ...
            {!submitted && currentStep === 2 && <Surface className="rounded-2xl" variant="glass" padding="md">
                ...
                <div className="flex gap-2 mt-3">
                  <Button variant="ghost" engine="protect" size="sm" className="text-xs !px-0 hover:underline">Regenerate</Button>
                  <Button variant="ghost" engine="protect" size="sm" className="text-xs text-white/40 hover:text-white/60">Edit manually</Button>
                </div>
              </Surface>
            }
            ...
            <div className="flex flex-col gap-4">
                ...
                <ButtonLink to="/protect" variant="ghost" engine="protect" size="sm" className="text-sm font-medium hover:opacity-80 transition-opacity !px-0">← Back to Protect</ButtonLink>
              </div>
            }
            ...
            <div className="flex justify-between mt-2">
                ...
                engine="protect"
                size="sm"
                className={`rounded-lg text-sm ${currentStep === 0 ? 'text-white/20 cursor-not-allowed' : 'text-white/50 hover:text-white/70'}`}>
