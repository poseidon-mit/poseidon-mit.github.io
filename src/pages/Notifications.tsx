...
const notifications: Notification[] = [
  ...
  },
  {
    ...
    engine: "Protect",
    category: "security",
    title: "Duplicate subscription charge detected",
    body: "Subscription service charged $14.99 twice on the same day.",
    time: "12m ago",
    read: false,
    actionLink: "/protect/alert-detail?alertId=THR-003",
  },
  {
    id: "N-003",
    engine: "Grow",
  ...
  },
  {
    ...
    engine: "Protect",
    category: "security",
    title: "Rideshare spending spike detected",
    body: "Rideshare spend spiked to $287 — 164% above your 6-month average of $109.",
    time: "6h ago",
    read: false,
    actionLink: "/protect/alert-detail?alertId=THR-005",
  },
  {
    id: "N-010",
    engine: "Protect",
    ...
    body: "4 micro-charges ($0.50–$1.50) across unknown merchants in 12 minutes.",
    time: "8h ago",
    read: false,
    actionLink: "/protect/alert-detail?alertId=THR-002",
  },
  {
    id: "N-011",
    engine: "Grow",
