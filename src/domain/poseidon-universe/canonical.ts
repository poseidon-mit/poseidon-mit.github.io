...
const PROTECT_THREATS: ProtectThreatEntity[] = [
  ...
  },
  {
    ...
    confidence: 0.91,
    severity: 'Medium',
    description: 'First-time crypto exchange transfer',
    relativeTime: '5d ago',
    sortOrder: 5,
  },
]
...
const EXECUTE_ACTIONS: ExecuteActionEntity[] = [
  ...
  },
  {
    ...
    description: '3 subscriptions in same merchant category (streaming media) detected — billing pattern suggests consolidation opportunity saving $140/mo',
    urgency: 'medium',
    impact: {
    ...
    factors: [
      ...
      { label: 'Category clustering', value: 0.88 },
    ...
    steps: [
      { id: 'EXE-003-S1', label: 'Analyze billing categories', description: 'AI analyzed billing categories and merchant codes across 12 active subscriptions', actor: 'agent', status: 'completed', requiresConsent: false, estimatedDuration: '4s' },
      { id: 'EXE-003-S2', label: 'Propose cancellations', description: '3 subscriptions in the same billing category identified for potential consolidation', actor: 'agent', status: 'completed', requiresConsent: false, estimatedDuration: '2s' },
