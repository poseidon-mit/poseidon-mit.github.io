...
export const AUDIT_DECISIONS: Record<string, AuditDecision> = {
  ...
  'GV-2026-0310-003': {
    ...
    action: 'High-yield savings opportunity — $900/yr',
    timestamp: '2026-03-10T09:15:00-07:00',
    model: { name: 'FinancialStrategyAI', version: '3.2.0', accuracy: 97.8 },
    explanation: {
      summary: 'Your Chase savings account earns 0.01% APY while high-yield alternatives offer 4.50% APY. Moving $20,000 would generate ~$900/year in additional interest with FDIC-insured accounts.',
      confidence: 0.92,
    },
    topFactors: [
      { label: 'Interest rate gap', contribution: 0.94, note: '4.49% APY difference between current (0.01%) and best available (4.50%)' },
      { label: 'Balance opportunity cost', contribution: 0.89, note: '$20,000 sitting idle — losing ~$75/month in potential interest' },
    ...
    coreAssertion: 'Poseidon identified $900/year in lost interest by comparing your savings rate to market alternatives',
    baseReality: [{ label: 'Current APY', value: '0.01%' }, { label: 'Available APY', value: '4.50%' }, { label: 'Balance', value: '$20,000' }, { label: 'Annual gain', value: '$900/year' }],
  },
  'GV-2026-0309-004': {
    id: 'GV-2026-0309-004',
    engine: 'Grow',
