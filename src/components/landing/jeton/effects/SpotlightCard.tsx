...
export default function SpotlightCard({
  ...
  return (
    <article
      ...
      className={cn(
        'group relative overflow-hidden rounded-3xl transition-all duration-300 hover:-translate-y-0.5',
        theme === 'dark'
          ? 'border border-white/10 bg-white/[0.04] shadow-[0_20px_46px_-34px_rgba(0,0,0,0.6)] hover:border-white/20 hover:bg-white/[0.06] text-white'
          : 'border border-slate-200/80 bg-white shadow-[0_20px_46px_-34px_rgba(15,23,42,0.35)] hover:border-slate-300 hover:shadow-[0_28px_56px_-30px_rgba(15,23,42,0.42)]',
        className,
      )}
    >
      <div
