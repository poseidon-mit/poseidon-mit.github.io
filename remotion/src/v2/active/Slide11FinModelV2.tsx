      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 5, minHeight: 0, marginTop: 8 }}>
              <div
                style={{
                  fontFamily: theme.typography.fontMono,
                  fontSize: layout.leftSectionTitleSize,
          ...
          >
            ...
            >
              ...
              <div
                style={{
                  fontFamily: theme.typography.fontMono,
                  fontSize: layout.stressTableTitleSize,
              ...
              >
                {['Scenario', 'Paid Conv.', 'Churn', 'Breakeven', 'Payback'].map((h) => (
                  <div
                    key={h}
                    style={{
                      fontFamily: theme.typography.fontMono,
                      fontSize: layout.stressTableHeaderSize,
              ...
              {/* Data rows */}
              {slide.stressTest.scenarios.map((row) => {
                const accentMap: Record<string, string> = {
                  emerald: theme.accent.emerald,
                  amber:   theme.accent.amber,
                  red:     '#EF4444',
                };
                const accent = accentMap[row.color] ?? theme.accent.teal;
                return (
                  <div
                    key={row.name}
                    style={{
                      display: 'grid',
                      gridTemplateColumns: 'repeat(5, 1fr)',
                      height: layout.stressTableRowHeight,
                      alignItems: 'center',
                  ...
                  >
                    <div
                      style={{
                        fontFamily: theme.typography.fontMono,
                        fontSize: layout.stressTableCellSize,
                        fontWeight: 700,
                        color: accent,
                      }}
                    >
                    ...
                    {[row.paidConv, row.churn, row.opBreakeven, row.payback].map((val, i) => (
                      <div
                        key={i}
                        style={{
                          fontFamily: theme.typography.fontMono,
