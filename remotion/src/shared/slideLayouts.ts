...
export const slideLayouts = {
  ...
  slide07v2: {
    ...
    playGlyphWidth: 36,
    playGlyphHeight: 46,
    youtubeCardWidth: 246,
    youtubeCardHeight: 286,
    youtubeCardRight: -300,
    youtubeCardBottom: 44,
    youtubeQrSize: 188,
    youtubeQrPad: 8,
    youtubeBadgeWidth: 168,
    youtubeBadgeHeight: 42,
    youtubeTitleSize: 24,
    youtubeBodySize: 18,
    youtubeMetaSize: 16,
  },
  ...
  slide11v2: {
    ...
    stressTableTitleSize: 13,
    stressTableHeaderSize: 13,
    stressTableCellSize: 15,
    stressTableRowHeight: 30,
  },
  slide12v2: {
    bodyGap: 14,
    gridColumns: '1fr 1fr',
    gridGap: 14,
    cardPadding: '16px 16px 14px',
    cardInnerGap: 9,
    riskIndexSize: 21,
    riskTitleSize: 30,
    chipSize: 17,
    chipGap: 8,
    mitigationTitleSize: 16,
    mitigationSize: 20,
    mitigationGap: 5,
    residualLabelSize: 16,
    residualValueSize: 17,
    residualNoteSize: 19,
  },
} as const;
