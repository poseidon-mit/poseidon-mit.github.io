...
const TEAM = [
  ...
  { id: 'member-04', name: 'Arun Kumar', initials: 'AK', contribution: '' },
] as const;
...
export const copy = {
  ...
  slide04: {
    ...
    engines: [
      ...
      },
      {
        ...
        name: 'Grow',
        bullets: [
          { id: 'forecast', text: 'Cashflow Forecast with confidence bands' },
          { id: 'spending', text: 'Spending Analysis and pattern detection' },
          { id: 'saving', text: 'Saving Opportunities routed to Execute' },
        ],
        badge: 'Growth Engine',
      ...
      },
      {
        ...
        name: 'Execute',
        bullets: [
          { id: 'compliant-ui', text: 'Regulatory Compliant UI for all financial actions.' },
          { id: 'steps', text: 'Minimum execution steps with guided action flow.' },
        ],
    ...
    phases: [
      {
        ...
        title: 'Foundation',
        bullets: [
          { label: 'Compliance', description: 'Bank-grade security and control' },
          { label: 'Governance', description: 'LLMOps / MLOps, Model management' },
          { label: 'Detection and Grow pilots', description: 'Model development and tests' },
          { label: 'Foundation Evaluation', description: 'Independent 3rd party assessment' },
          { label: 'Business case refinement', description: 'Refresh based on the Phase 1 outcome' },
        ],
      ...
      },
      {
        ...
        title: '',
        bullets: [],
        goal: 'Execute engine development and MVP release',
        definition: '',
        gateMetrics: [
          { label: 'Recall', target: '>70%', value: 70 },
          { label: 'False Pos', target: '<30%', value: 30 },
        ],
        color: '#3B82F6',
      },
      {
        ...
        definition: '',
        gateMetrics: [
          { label: 'Recall', target: '>80%', value: 80 },
          { label: 'Precision', target: '>70%', value: 70 },
          { label: 'False Pos', target: '<20%', value: 20 },
        ],
        color: '#00d5cc',
      },
      {
        ...
        label: 'Phase 4',
        period: '24+ Months',
        pillar: 'Advanced recommendation',
        title: 'Scale',
        bullets: [],
        goal: 'Deeper recommendation',
        definition: '',
        gateMetrics: [
          { label: 'Recall', target: '>90%', value: 90 },
          { label: 'Precision', target: '>80%', value: 80 },
          { label: 'False Pos', target: '<10%', value: 10 },
        ],
        color: '#F59E0B',
      },
    ],
  ...
  slide12: {
    ...
    risks: [
      ...
      {
        id: 'risk-02',
        inherentRisk: 'Security Threats (external, insider, and supply chain)',
        ratingImpact: 'High',
        ratingLikelihood: 'High',
        mitigations: [
      ...
      {
        id: 'risk-03',
        inherentRisk: 'LLM hallucination / misleading explanations.',
        ratingImpact: 'Medium',
        ratingLikelihood: 'High',
        mitigations: [
      ...
      {
        id: 'risk-04',
        inherentRisk: 'Bias and Fairness',
        ratingImpact: 'High',
      ...
      {
        id: 'risk-06',
        inherentRisk: 'System resiliency',
        ratingImpact: 'High',
        ratingLikelihood: 'Medium',
        mitigations: [
